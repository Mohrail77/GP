          ...
          child: Column(
            children: [
              ...
              Visibility(
                visible: v21,
                child: send(
                  message: 'What is red-green color blindness',
                  function: () {
                    setState(() {
                      v21A = true;
                      v211 = true;
              ...
              Visibility(
                ...
                child: Answer(
                    message:
                        ' blue-yellow is the less-common type of color blindness makes it hard to tell the difference between blue and green, and between yellow and red.'),
              ),
